...
/**
 * Variable Header containing only Message Id See <a
 * href="http://public.dhe.ibm.com/software/dw/webservices/ws-mqtt/mqtt-v3r1.html#msg-id">MQTTV3.1/msg-id</a>
 */
public final class MqttPacketIdVariableHeader {
  ...
  public String toString() {
    return StringUtil.simpleClassName(this) + '[' + "packetId=" + packetId + ']';
  }
}
